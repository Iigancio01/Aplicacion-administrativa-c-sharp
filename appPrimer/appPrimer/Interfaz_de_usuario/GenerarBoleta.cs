...
namespace appPrimer
{
    public partial class GenerarBoleta : Form
    {
        ...
        public void btnGenerarBoleta_Click(object sender, EventArgs e)
        {

            try
            {
                Boleta bole = new Boleta(txtNroboleta.Text, lbTotal.Text, txtFecha.Text, txtCodcliente.Text, txtTipopago.Text);
                d.GuardarBoleta(bole);
